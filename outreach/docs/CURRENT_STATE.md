...
- Очередь: due follow-up, первые письма, колонки город / TZ / **окно** (`сейчас` или следующий слот)
- Настройки: **локальные B2B-окна** (слоты, дни, default TZ) — основной режим; legacy «с часа до часа МСК» — advanced
- Клиенты: пайплайн **1. Bitrix sync → 2. Дотянуть geo/ФИО → 3. Обновить очередь**

Статика пульта и outreach должна совпадать: `scripts/sync-outreach-ui.sh`.
