...
DEFAULT_STEPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "plain": (
            "Добрый день, {name}!\n\n"
            "Коротко напомню: предлагаем **подключить массовые выплаты** "
            "вашим клиентам на карту и по СБП.\n\n"
            "Даже если выплаты уже есть — часто можно согласовать условия выгоднее "
            "(ориентир комиссии примерно от 1,5% до 0,4% при больших объёмах) "
            "в вашем банке или у банка-партнёра. Технически — интеграция "
            "или наш личный кабинет.\n\n"
            "Если тема неактуальна — ответьте «неинтересно», больше писать не буду.\n\n"
            "С уважением,\n{company}\n"
        ),
        "html": None,
        "label": "bump",
