...
PACKS: dict[str, dict[str, Any]] = {
    "lombards": {
        "id": "lombards",
        "title": "Ломбарды",
        "short": "Выплаты на карту вашим клиентам + прямые договоры с банками, минимальные ставки комиссии, tech-партнёр",
        ...
        "steps": [
            _step(
                ...
                delay_days=0,
                label="intro",
                subject="Выплаты на карту вашим клиентам и по СБП — без посредника",
