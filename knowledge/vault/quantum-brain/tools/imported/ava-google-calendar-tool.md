...
source: imported:/root/ava/docs/Google-calendar-tool.md
shard: ava-google-calendar-tool
---

# Google calendar tool notes

> Imported from `/root/ava/docs/Google-calendar-tool.md` for Second Brain. Secrets must not be added here.
