...
source: imported:/root/ava/docs/TELEPHONY_TOOLS_SURFACE_AUDIT.md
shard: ava-telephony-tools-audit
---

# Telephony tools surface audit

> Imported from `/root/ava/docs/TELEPHONY_TOOLS_SURFACE_AUDIT.md` for Second Brain. Secrets must not be added here.
